...
const turnApiUrl = 'https://ps.pndsn.com/v1/blocks/sub-key/sub-c-9516d6bc-48b4-11ea-b828-26d2a984a2e5/turn-credentials';
let turnToken;
request(turnApiUrl, 'GET').then((response) => { turnToken = response });
console.log('turnToken', turnToken);
...
const initWebRtcApp = () => {
            ...
            confirmCall(name).then((yesDoCall) => {
                if (yesDoCall) {
                    ...
                    request(turnApiUrl, 'PUT', {
                        ...
                        console.log('call confirm', response);
    ...
    pubnub = new PubNub({
        publishKey: 'pub-c-c30e495b-ea21-4856-a45f-0949d312760a',
        subscribeKey: 'sub-c-9516d6bc-48b4-11ea-b828-26d2a984a2e5'
    });
...
function getLocalStream() {
    ...
    return new Promise((resolve, reject) => {
        const constant = { video: true, audio: true }
        navigator.mediaDevices.getUserMedia(constant)
            .then(avStream => resolve(avStream))
            .catch(err => {
